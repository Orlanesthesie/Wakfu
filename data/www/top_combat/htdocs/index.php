...
?>
<audio autoplay loop>
  <source src="./assets/son/Astrub.mp3" type="audio/mp3">
</audio>
<body class="poire" style="background-image: url('./assets/images/poire.jpg')">

<!-- VICTORY -->
<a href ="./victory.php"><img src="./assets/images/victoire.png" class="victoire"></a>
    ...
    <div class="d-flex flex-wrap heros row justify-content-around mb-5">
        ...
        <div class="card col-3 blur" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <form action="./fight.php" method="post" class="form">
                    <button class="btn mt-2 bouton" type="submit"> <img src="./assets/images/swords.png" id="swords"> </button>
                </form>
                </p>
            </div>
        </div>
        ...
        <div class="card col-3 blur" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped bg-success progress-bar-animated" role="progressbar" aria-valuenow="<?= $hero1->getHeroHealth_points() ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?= $hero1->getHeroHealth_points() ?>%"></div>
                </div>
                <div id="form">
                    <!-- EPEE -->
                    <form action="./fight.php" method="post" class="form">
                    ...
                    <form action="./process/heal.php" method="post" class="form">
                        <input id="id_select_hero" type="hidden" name="id_select_hero" value="10">
                        <button class="btn mt-2 bouton" type="submit"> <img src="./assets/images/heal.png" id="heal"> </button>
                    </form>
                    <!-- BOOST -->
                    <form action="./process/boost.php" method="post" class="form">
                        <input id="id_select_hero" type="hidden" name="id_select_hero" value="10">
                        <button class="btn mt-2 bouton" type="submit"> <img src="./assets/images/egg.png" id="boost"> </button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="card col-3 blur" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped bg-success progress-bar-animated" role="progressbar" aria-valuenow="<?= $hero2->getHeroHealth_points() ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?= $hero2->getHeroHealth_points() ?>%"></div>
                </div>
                <div id="form">
                    <!-- EPEE -->
                    <form action="./fight.php" method="post" class="form">
        ...
        <div class="card col-3 blur" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped bg-success progress-bar-animated" role="progressbar" aria-valuenow="<?= $hero3->getHeroHealth_points() ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?= $hero3->getHeroHealth_points() ?>%"> </div>
                </div>
                <div id="form">
                    <!-- EPEE -->
                    <form action="./fight.php" method="post" class="form">
